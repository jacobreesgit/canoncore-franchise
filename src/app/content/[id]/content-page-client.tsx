...
import { Navigation, PageHeader, DeleteConfirmationModal, Button, ButtonLink, LoadingSpinner, PageContainer, Badge, ContentSection } from '@/components';
...
export default function ContentPageClient({ params }: Props) {
  ...
  const { content, updateProgress, isUpdating } = useContentProgress(initialContent, user?.id || '');
