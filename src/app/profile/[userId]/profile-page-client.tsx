...
export default function ProfilePageClient({ userId, initialUser }: ProfilePageClientProps) {
  ...
  const [profileLoading, setProfileLoading] = useState(!initialUser);
  ...
  useEffect(() => {
    const fetchProfileData = async () => {
      try {
        ...
        // Get user data if not provided initially
  ...
  }, [userId, currentUser, loading, profileUser]);
