...
const meta: Meta<typeof PageContainer> = {
  title: 'CanonCore/Layout/PageContainer',
      ...
      <div>
        ...
        <div className="bg-white rounded-lg shadow p-6 mt-6">
          <form className="space-y-4">
            <div>
              <label htmlFor="storybook-name" className="block text-sm font-medium text-gray-700 mb-1">Name *</label>
              <input
                id="storybook-name"
                type="text"
            ...
            <div>
              <label htmlFor="storybook-description" className="block text-sm font-medium text-gray-700 mb-1">Description</label>
              <textarea
